...
public class PipelineWithOneHotEncoder {
	...
	public static PipelineModel create_pipeline() {
		...
		StringIndexer category1Indexer = new StringIndexer().setInputCols(new String[] { "category_1", "category_2" })
				.setOutputCols(new String[] { "category_1_index", "category_2_index" });
		...
		// setup the pipeline
		Pipeline pipeline = new Pipeline().setStages(new PipelineStage[] { category1Indexer, oneHotEncoder });
